...
const tableData = reactive<MenuTree[]>([])
...
<template>
  <div ref="pageRef" class="page-main">
    <data-form ref="dataFormRef" :data="formData" @query-callback="queryCallback">
      <t-col :span="3">
    ...
    >
      <t-row :gutter="[16, 24]" class="w-10">
        ...
        <t-col v-if="panlForm.form.menuType !== MenuTypeEnum.BUTTON" :span="12">
        ...
        <t-col v-if="panlForm.form.menuType === MenuTypeEnum.MENU" :span="12">
        ...
        <t-col v-if="panlForm.form.menuType === MenuTypeEnum.MENU" :span="6">
